...
* The resulting Solar Heliographic coordinate system files are then used to create the plots and info in this directory (via SSWIDL at the moment), and of course can be used for science as well, or even just viewing via software like [ds9](http://ds9.si.edu/site/Home.html).
