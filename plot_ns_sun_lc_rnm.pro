pro plot_ns_sun_lc_rnm, obsname=obsname,timer=timer,goes=goes,gyr=gyr,tav=tav,$
  ...
  if (n_elements(obsname) ne 1) then obsname='202412_24'
  ...
  if (obsname eq '202303_18') then begin      
    torbs=[['18-Mar-23 13:30:41','18-Mar-23 14:30:03'],$
      ['18-Mar-23 15:07:09','18-Mar-23 16:06:31'],$
      ['18-Mar-23 16:43:36','18-Mar-23 17:42:59'],$
      ['18-Mar-23 18:20:04','18-Mar-23 19:19:26'],$
      ['18-Mar-23 19:56:29','18-Mar-23 20:37:10'],$
      ['18-Mar-23 21:41:51','18-Mar-23 22:23:23'],$
      ['18-Mar-23 23:09:26','19-Mar-23 00:07:28']]  
    timer=['18-Mar-23 12:00:00','19-Mar-23 01:00:00']
    nsdir='ns_20230318'
    hkf=file_search(maindir+nsdir,'*A_fpm.hk')
    hkf=hkf[where(strpos(hkf,'/hk/') ge 0)]
    chuf=file_search(maindir+nsdir, '*chu123.fits')
  ...
  if (obsname eq '202312_28') then begin
    torbs=[['28-Dec-23 14:18:49','28-Dec-23 15:19:19'],$
      ['28-Dec-23 15:55:05','28-Dec-23 16:55:37'],$
      ['28-Dec-23 20:01:54','28-Dec-23 20:08:10'],$
      ['28-Dec-23 20:43:55','28-Dec-23 21:44:27'],$
      ['28-Dec-23 22:20:12','28-Dec-23 23:20:44'],$
      ['28-Dec-23 23:56:28','29-Dec-23 00:57:01'],$
      ['29-Dec-23 01:32:46','29-Dec-23 02:33:18']]
    timer=['28-Dec-23 13:00:00','29-Dec-23 03:30:00']
    nsdir='ns_20231228'
    hkf=file_search(maindir+nsdir,'*A_fpm.hk')
    hkf=hkf[where(strpos(hkf,'/hk/') ge 0)]
    chuf=file_search(maindir+nsdir, '*chu123.fits')
  ...
  if (obsname eq '202403_30') then begin
    torbs=[['30-Mar-24 13:29:23','30-Mar-24 14:23:27'],$
      ['30-Mar-24 15:28:57','30-Mar-24 16:04:36'],$
      ['30-Mar-24 16:41:47','30-Mar-24 17:40:48'],$
      ['30-Mar-24 18:17:58','30-Mar-24 19:11:24'],$
      ['30-Mar-24 19:54:10','30-Mar-24 20:53:12'],$
      ['31-Mar-24 00:42:49','31-Mar-24 01:41:47'],$
      ['31-Mar-24 02:18:58','31-Mar-24 03:17:59']]
    timer=['30-Mar-24 12:00:00','31-Mar-24 04:00:00']
    nsdir='ns_20240330'
    hkf=file_search(maindir+nsdir,'*A_fpm.hk')
    hkf=hkf[where(strpos(hkf,'/hk/') ge 0)]
    chuf=file_search(maindir+nsdir, '*chu123.fits')
  ...
  if (obsname eq '202407_16') then begin
    torbs=[['16-Jul-24 11:03:03','16-Jul-24 12:03:27'],$
      ['16-Jul-24 12:39:10','16-Jul-24 12:55:43'],$
      ['16-Jul-24 14:57:06','16-Jul-24 15:15:37'],$
      ['16-Jul-24 15:51:33','16-Jul-24 16:51:54'],$
      ['16-Jul-24 17:27:33','16-Jul-24 17:48:34'],$
      ['16-Jul-24 19:03:39','16-Jul-24 20:04:01'],$
      ['17-Jul-24 04:40:18','17-Jul-24 05:40:38'],$
      ['17-Jul-24 06:16:24','17-Jul-24 06:32:04"']]
    timer=['16-Jul-24 10:00:00','17-Jul-24 08:30:00']
    nsdir='ns_20240716'
    hkf=file_search(maindir+nsdir,'*A_fpm.hk')
    hkf=hkf[where(strpos(hkf,'/hk/') ge 0)]
    chuf=file_search(maindir+nsdir, '*chu123.fits')
  ...
  if (obsname eq '202412_24') then begin
    torbs=[['24-Dec-24 10:11:17','24-Dec-24 11:11:02'],$
      ['24-Dec-24 11:49:35','24-Dec-24 12:46:53'],$
      ['24-Dec-24 13:23:00','24-Dec-24 14:22:44'],$
      ['24-Dec-24 14:58:51','24-Dec-24 15:58:36']]
    timer=['24-Dec-24 09:30:00','24-Dec-24 16:30:00']
    nsdir='ns_20241224'
    hkf=file_search(maindir+nsdir,'*A_fpm.hk')
    hkf=hkf[where(strpos(hkf,'/hk/') ge 0)]
    chuf=file_search(maindir+nsdir, '*chu123.fits')
